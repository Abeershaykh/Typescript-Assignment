...
let transport = ['Car', 'Bike', 'Truck', 'Redbus'];
...
let Invitation = ['Ozil', 'Sanchez', 'Saka'];
...
let Unaivalableguest = 'Sanchez';
let Newguest = 'Martinelli';
...
let locations = ['London', 'Paris', 'New York', 'Melbourne', 'Chicago'];
...
let mountians = ['Mount Arafah', 'Himalayas', 'K2'];
let rivers = ['River Indus', 'River Satlaj', 'River Raavi'];
let countries = ['Pakistan', 'India', 'Australia'];
let cities = ['Manchester', 'Brisbane', 'Lahore'];
let languages = ['Urdu', 'English', 'Deutsch'];
...
let players = ['Saka', 'Martinelli', 'Trossard', 'Rice'];
...
let username = ['Abeer', 'Haroon', 'Bilal', 'Umar', 'Admin'];
...
let current_users = ['Abeershaikh1', 'Abeershaikh2', 'Abeershaikh3', 'Abeershaikh4', 'Abeershaikh5'];
//Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
let new_users = ['Abeershaikh2', 'Abeershaikh3', 'Abeershaikh6', 'Abeershaikh7', 'Abeershaikh8'];
...
let pizzas = ['Afghani', 'Chicken', 'Fajita'];
...
const magicianNames = ['Harry Potter', 'Rudolph', 'Ozil', 'KDB'];
